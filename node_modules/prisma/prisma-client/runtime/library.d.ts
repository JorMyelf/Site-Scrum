 ...
 */
export declare type Result_2<T, A, F extends Types.Result.Operation> = Types.Public.Result<T, A, F>;
...
export declare type Result_4<T, A, F extends Operation> = T extends {
    [K: symbol]: {
        types: {
            payload: any;
        };
...
export declare interface Transaction_2 extends Queryable {
    /**
     * Transaction options.
     */
...
export declare type TransactionOptions_2 = {
