...
// ../../node_modules/.pnpm/@prisma+engines-version@5.4.0-43.6b4d2fc685ddd87d33b4efa5b8ff961f4cf2fec5/node_modules/@prisma/engines-version/package.json
var require_package = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.4.0-43.6b4d2fc685ddd87d33b4efa5b8ff961f4cf2fec5/node_modules/@prisma/engines-version/package.json"(exports, module2) {
    module2.exports = {
      ...
      prisma: {
        enginesVersion: "6b4d2fc685ddd87d33b4efa5b8ff961f4cf2fec5"
      },
      repository: {
        type: "git",
...
// ../../node_modules/.pnpm/@prisma+engines-version@5.4.0-43.6b4d2fc685ddd87d33b4efa5b8ff961f4cf2fec5/node_modules/@prisma/engines-version/index.js
var require_engines_version = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.4.0-43.6b4d2fc685ddd87d33b4efa5b8ff961f4cf2fec5/node_modules/@prisma/engines-version/index.js"(exports) {
    "use strict";
...
var require_lib2 = __commonJS({
  "../../node_modules/.pnpm/@babel+highlight@7.22.20/node_modules/@babel/highlight/lib/index.js"(exports) {
    ...
    function shouldHighlight(options2) {
      return _chalk.default.level > 0 || options2.forceColor;
    }
    ...
    {
      exports.getChalk = (options2) => getChalk(options2.forceColor);
    }
    function highlight(code, options2 = {}) {
      if (code !== "" && shouldHighlight(options2)) {
        const defs = getDefs(getChalk(options2.forceColor));
...
var require_semver = __commonJS({
  "../../node_modules/.pnpm/semver@5.7.2/node_modules/semver/semver.js"(exports, module2) {
    ...
    function parse(version, options2) {
      ...
      var r = options2.loose ? safeRe[LOOSE] : safeRe[FULL];
      if (!r.test(version)) {
        return null;
      }
      try {
    ...
    function SemVer(version, options2) {
      ...
      var m = version.trim().match(options2.loose ? safeRe[LOOSE] : safeRe[FULL]);
      if (!m) {
        throw new TypeError("Invalid Version: " + version);
      }
      this.raw = version;
    ...
    function replaceTilde(comp, options2) {
      var r = options2.loose ? safeRe[TILDELOOSE] : safeRe[TILDE];
    ...
    function replaceCaret(comp, options2) {
      ...
      var r = options2.loose ? safeRe[CARETLOOSE] : safeRe[CARET];
      return comp.replace(r, function(_, M, m, p, pr) {
    ...
    function replaceXRange(comp, options2) {
      comp = comp.trim();
      var r = options2.loose ? safeRe[XRANGELOOSE] : safeRe[XRANGE];
...
var require_package3 = __commonJS({
  "package.json"(exports, module2) {
    module2.exports = {
      ...
      dependencies: {
        "@prisma/engines-version": "5.4.0-43.6b4d2fc685ddd87d33b4efa5b8ff961f4cf2fec5"
      },
      sideEffects: false
    };
  }
...
`;
  ...
  buildClientOptions() {
    ...
    if (this.runtimeName === "library" && this.generator?.previewFeatures.includes("driverAdapters")) {
      clientOptions.add(
        property("adapter", namedType("runtime.DriverAdapter")).optional().setDocComment(
